...
export class CustomResourceConversionHelper extends Template implements CustomResourceConversionHelper {
    ...
    _webhookClientConfig: any;
    get webhookClientConfig(): any /*WebhookClientConfigHelper*/ {
        return this._webhookClientConfig
    }
    set webhookClientConfig(x: any /*WebhookClientConfigHelper*/) {
        this._webhookClientConfig = x
    }
    setWebhookClientConfig(x: any /*WebhookClientConfigHelper*/) {
...
export class CustomResourceDefinitionSpecHelper extends Template implements CustomResourceDefinitionSpecHelper {
    ...
    _validation: any;
    get validation(): any /*CustomResourceValidationHelper*/ {
        return this._validation
    }
    set validation(x: any /*CustomResourceValidationHelper*/) {
        this._validation = x
    }
    setValidation(x: any /*CustomResourceValidationHelper*/) {
