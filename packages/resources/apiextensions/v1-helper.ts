...
export class CustomResourceConversionHelper extends ResourceTemplate {
    ...
    webhook(webhook: WebhookConversion): CustomResourceConversionHelper {
        if (!this._template.webhook) this._template.webhook = []
        this._template.webhook = {
            ...this._template.webhook,
            ...webhook
        }
        return this
...
export class WebhookConversionHelper extends ResourceTemplate {
    static kind = 'WebhookConversion';
    static apiVersion = 'apiextensions/v1';

    clientConfig(clientConfig: WebhookClientConfig): WebhookConversionHelper {
    ...
    conversionReviewVersions(conversionReviewVersions: Array<string>): WebhookConversionHelper {
    ...
    constructor(name, namespace) {
        super(name, namespace)
        this._template.kind = WebhookConversionHelper.kind
        this._template.apiVersion = WebhookConversionHelper.apiVersion
    }
}
