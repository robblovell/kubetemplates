...
import { NonResourceAttributes, NonResourceRule, ResourceAttributes, ResourceRule, SelfSubjectAccessReviewSpec, SelfSubjectRulesReviewSpec, SubjectAccessReviewSpec, SubjectAccessReviewStatus, SubjectRulesReviewStatus } from "./v1beta1";
...
export class SubjectAccessReviewSpecHelper extends ResourceTemplate {
    ...
    group(group: Array<string>): SubjectAccessReviewSpecHelper {
        if (!Array.isArray(group)) { group = [group] }
        if (!this._template.group) this._template.group = group
        this._template.group = [...this._template.group, ...group]
        return this
    }
